...
class Agent():
    ...
    def __init__(self, config):
        ...
        self.critic_optimizer = optim.Adam(self.critic_local.parameters(), lr=self.config.lr_critic, weight_decay=WEIGHT_DECAY)
...
class OUNoise:
    ...
    def __init__(self, n_steps=10000, output_dim=1, mu=0., theta=0.15, sigma=0.3, x0=0, dt=1e-2):
